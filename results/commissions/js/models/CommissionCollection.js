...
define([
    ...
    "systemConfig",
   	"CommissionModel"
], function(PagedCollection, systemConfig, CommissionModel) {
	 ...
	 * </p>
	 *
	 * Returned list is consumed by {@link module:CommissionModel}
	 *
	 * @module CommissionCollection
	 */
    var CommissionCollection = PagedCollection.extend({
         ...
         * @type {String}
         */
        url: systemConfig.appContext+"/api/commissions/v1",
