...
define([
    ...
    "systemConfig",
   	"DrawModel"
], function(PagedCollection, systemConfig, DrawModel) {
	 ...
	 */
    var DrawCollection = PagedCollection.extend({
        ...
        sortMap :{
            ...
            'eligibleAmountWithUnitType' : 'eligibleAmount',
            'payAmountWithUnitType' : 'payAmount',
            'balanceWithUnitType' : 'balance'
