...
define([
    ...
    "systemConfig",
   	"CreditsModel"
], function(PagedCollection, systemConfig, CreditsModel) {

	/**
	 * A Backbone collection that holds and fetches Credits data.
	 *
	 ...
	 * </p>
	 *
	 * Returned list is consumed by {@link module:CreditsModel}
	 *
	 * @module CreditsCollection
	 */
    var CreditsCollection = PagedCollection.extend({

    	 /**
         * A Backbone model representing each object in this collection.
         *
         * @type {Backbone.Model} {@link module:CreditsModel}
         */
        model: CreditsModel,
         ...
         * @type {String}
         */
        url: systemConfig.appContext+"/api/credits/v1",
